...
public class sslpost {
	...
	public VCard parseHTMLForVCardInformation( String html ) {
		...
		//Pattern findFullnamePattern = Pattern.compile("txtheader\">([\\w������]+)\\s+([\\w������]+)");
		Pattern findFullnamePattern = Pattern.compile("txtheader\">([\\s\\d\\w�������]+)\\suppgifter<\\/div");
		...
		// <tr><td class=\"maintxt\">Bes�ksadress&nbsp;&nbsp;</td><td class=\"maintxt\">�landsgatan 42</td></tr><tr><td class=\"maintxt\">Postadress&nbsp;&nbsp;</td><td class=\"maintxt\">�landsgatan 42</td></tr><tr><td class=\"maintxt\">Postnr&nbsp;&nbsp;</td><td class=\"maintxt\">116 63</td></tr><tr><td class=\"maintxt\">Postort&nbsp;&nbsp;</td><td class=\"maintxt\">STOCKHOLM</td></tr><tr><td class=\"maintxt\">Land&nbsp;&nbsp;</td><td class=\"maintxt\">Sverige</td></tr><tr><td class=\"maintxt\">E-post&nbsp;&nbsp;</td><td class=\"maintxt\">";
		Pattern findStreetPattern = Pattern.compile("Bes�ksadress&nbsp;&nbsp;<.td><td class=\"maintxt\">([-+\\s\\d\\w�������]+)");
		Matcher findStreetMatcher = null;
		Pattern findZipPattern = Pattern.compile("Postnr&nbsp;&nbsp;<.td><td class=\"maintxt\">([-+\\s\\d\\w�������]+)");
		Matcher findZipMatcher = null;
		Pattern findCityPattern = Pattern.compile("Postort&nbsp;&nbsp;<.td><td class=\"maintxt\">([-+\\s\\d\\w�������]+)");
		Matcher findCityMatcher = null;
		Pattern findCountryPattern = Pattern.compile("Land&nbsp;&nbsp;<.td><td class=\"maintxt\">([-+\\s\\d\\w�������]+)");
	...
	public void testVCardParsing() {
		...
		String html = "<div class=\"txtheader\">Bj�rn 2 Eriksson uppgifter</div>\n";
		...
		html += "<tr><td class=\"maintxt\">Bes�ksadress&nbsp;&nbsp;</td><td class=\"maintxt\">�landsgatan 42</td></tr><tr><td class=\"maintxt\">Postadress&nbsp;&nbsp;</td><td class=\"maintxt\">�landsgatan 42</td></tr><tr><td class=\"maintxt\">Postnr&nbsp;&nbsp;</td><td class=\"maintxt\">116 63</td></tr><tr><td class=\"maintxt\">Postort&nbsp;&nbsp;</td><td class=\"maintxt\">STOCKHOLM</td></tr><tr><td class=\"maintxt\">Land&nbsp;&nbsp;</td><td class=\"maintxt\">Sverige</td></tr><tr><td class=\"maintxt\">E-post&nbsp;&nbsp;</td><td class=\"maintxt\">";
